...
using ZeroFormatter.DotNetCore.Comparers;
...
namespace ZeroFormatter.DotNetCore.Segments
{
    ...
    public sealed class DictionarySegment<TKey, TValue> : IDictionary<TKey, TValue>, IZeroFormatterSegment
    {
        ...
        public static DictionarySegment<TKey, TValue> Create(DirtyTracker tracker, byte[] bytes, int offset, out int byteSize)
        {
