...
namespace ZeroFormatter.DotNetCore.Segments
{
    ...
    public static class ObjectSegmentHelper
    {
        ...
        public static int SerializeFixedLength<T>(ref byte[] targetBytes, int startOffset, int offset, int index, ArraySegment<byte> originalBytes)
        {
            ...
            var formatter = global::ZeroFormatter.DotNetCore.Formatters.Formatter<T>.Default;
    ...
    internal static class DynamicObjectSegmentBuilder<T>
    {
        ...
        static List<PropertyTuple> GetProperties(TypeBuilder typeBuilder)
        {
            ...
            var props = typeof(T).GetTypeInfo().GetProperties(BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance)
        ...
        static void BuildConstructor(TypeBuilder type, FieldInfo originalBytesField, FieldInfo trackerField, FieldInfo lastIndexField, List<PropertyTuple> properties)
        {
            ...
            var baseCtor = typeof(T).GetTypeInfo().GetConstructors(BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic).FirstOrDefault();
        ...
        //    MethodInfo invokeMethod = typeof(HubContext).GetTypeInfo().GetMethod(
        ...
        //    foreach (var method in interfaceType.GetTypeInfo().GetMethods())
        //    {
